...
- Is a collection of wrapper functions, mainly, generated to resolve common tasks when working with large scale assessment data, analysis of secondary data from large national records, and nested data observations
...
- z_score is not being exported, fix the latest update (20190416)
- add sample data to show functions examples
- add a viggnete
- add merge function
- add checks for nested data (i.e. check if clustering variables are unique across a data frame)
