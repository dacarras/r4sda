...
- Is a collection of wrapper functions, mainly, generated to resolve common tasks I often do when working with large scale assessment data.
- It generates tables, variables tables, checks for nested data [pending], merge functions [pending]
...
You can install the development version of r4sda from this [github](https://github.com/dacarras/r4sda) repository with:
